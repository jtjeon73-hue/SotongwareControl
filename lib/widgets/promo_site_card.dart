...
class PromoSiteCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final urlDisplay = state.promoUrlDisplay(site.id);
    final hasUrl = state.hasPromoUrl(site.id);
        ...
        child: Column(
          ...
          children: [
            ...
            if (!compact) ...[
              ...
              _InfoRow(label: '제작 상태', value: site.productionStatus),
              _InfoRow(label: '다음 작업', value: site.nextTask, highlight: true),
            ] else ...[
            ...
            Container(
              ...
              child: Row(
                children: [
                  ...
                  Expanded(
                    child: Text(
                      hasUrl ? urlDisplay : '예상 URL: $urlDisplay',
                      style: Theme.of(context).textTheme.bodyMedium?.copyWith(
                        fontSize: 11,
                        color: hasUrl
                            ? ControlColors.teal
                  ...
                  if (hasUrl)
                    IconButton(
                      ...
                      tooltip: 'URL 복사',
                      onPressed: () => _copyUrl(context, urlDisplay),
