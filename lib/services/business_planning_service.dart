...
class BusinessPlanningService {
  ...
  static const ebookWorkflowStages = <(String, String, String)>[
    ...
    ('user_review', '편집 내부 체크포인트', '내부 편집 체크포인트(자동 통과 가능)'),
    ...
    (
      'package_user_review',
      '완성형 r1 사용자 검토',
      '원고·표지·PDF·EPUB·manifest가 준비된 완성형 r1을 사용자가 검토함',
    ),
    ('final_polish', '최종 폴리시', '최종 폴리시·판매 메타 보고서가 존재함'),
    (
      'final_user_approval',
      '최종 사용자 승인',
  ...
  String _ebookProductionInstructionNotes(BusinessPlanInput input) {
    ...
    final sections = <String>[
      ...
      marker,
      '[ebook:v2]',
      'STEP9 user_review = 편집 내부 체크포인트(자동 가능).',
      'STEP15 package_user_review = 완성형 r1 사용자 검토(PDF/EPUB/cover, 자동승인 금지).',
      'STEP13 format_build = publish/book.pdf|epub SSOT. STEP17 final_user_approval = 판매 전 최종 승인.',
