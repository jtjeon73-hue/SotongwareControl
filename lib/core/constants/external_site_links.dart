...
class ExternalSiteLinks {
  ...
  static const apps = ExternalSiteLink(
    id: 'apps',
    title: '소통웨어 앱개발',
    subtitle: '앱 개발 사업',
  ...
  static const ebook = ExternalSiteLink(
    id: 'ebook',
    title: '소통웨어 전자책',
    subtitle: '전자책 사업',
  ...
  static const contents = ExternalSiteLink(
    id: 'contents',
    title: '소통웨어 콘텐츠',
    subtitle: '콘텐츠·음악',
  ...
  static const aiStory = ExternalSiteLink(
    id: 'ai_story',
    title: '소통AI스토리',
    subtitle: 'AI 지식 플랫폼',
  ...
  static const marketing = ExternalSiteLink(
    id: 'marketing',
    title: '소통마케팅',
    subtitle: '홍보·마케팅',
