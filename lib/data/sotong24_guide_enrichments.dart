...
class Sotong24GuideEnrichments {
  ...
  static final ebook = <String, Sotong24StageGuideEnrichment>{
    ...
    'publish_prep': Sotong24StageGuideEnrichment(
      ...
      mainTasks: [
        '등록 플랫폼 유형과 판매자 계정 준비 확인',
        '플랫폼별 PDF/표지/미리보기 파일 규격 확인',
        '제목·소개·카테고리·키워드·가격 입력안 작성',
        'ISBN 필요 여부와 심사/승인 절차 확인',
        '판매 시작 전 최종 체크리스트 작성',
      ],
      inputs: ['품질 리포트', '최종 PDF', '표지', '저작권·출처 표'],
      deliverables: ['최종 PDF', '표지', '등록 metadata', '등록 체크리스트'],
      qualityCriteria: [
        '제목·가격·설명 완비',
        '저작권/출처 고지',
        '플랫폼 입력 항목 누락 없음',
      ...
      approvalCriteria: ['제목', '가격', '상품 설명', '미리보기', '저작권/출처', '실제 등록 여부'],
      commonProblems: ['가격 미정', '설명 과장'],
      cautions: [
        '플랫폼 규정과 충돌하는 문구 금지',
        '플랫폼 정책·수수료·규격은 바뀔 수 있으므로 실제 등록 화면에서 최신값 재확인',
        '사용자 명시 승인 전 외부 업로드·공개·판매 시작 금지',
      ],
      completionConditions: ['등록 필수 항목과 파일이 준비되고 외부 publish는 실행되지 않음'],
    ),
    ...
    'maintain': Sotong24StageGuideEnrichment(
      ...
      mainTasks: [
        '오탈자·깨진 링크·변경된 통계/정책 정기 점검',
        '독자 피드백과 판매 지표를 개선 백로그에 반영',
        'PDF 새 버전 생성·수정 이력·버전 번호 관리',
        '가격·소개문·키워드 개선과 재출시 여부 판단',
        '원본·최종본·등록자료 백업과 업데이트 주기 기록',
      ],
      inputs: ['개선 목록', '독자 피드백', '판매 지표', '현재 PDF'],
      deliverables: ['유지 로그', '수정 이력', '새 버전 PDF'],
      qualityCriteria: ['백업 존재', '버전과 수정 이력 일치', '링크·정책 최신성'],
      approvalCriteria: ['유지 주기 확인', '가격 변경/재출시 승인'],
      commonProblems: ['백업 없음', '구버전과 최신본 혼동', '정책·링크 방치'],
      cautions: ['운영 Firestore 데이터 임의 삭제 금지', '새 버전 외부 등록은 다시 사용자 승인'],
      completionConditions: ['백업·수정 이력·업데이트 주기·재출시 판단 기준이 문서화됨'],
    ),
  };
